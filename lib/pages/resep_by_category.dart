...
class ResepKategoriList extends StatefulWidget {
  final String keyword;
  final String kategori;

  const ResepKategoriList(
      {Key? key, required this.keyword, required this.kategori})
      : super(key: key);

  @override
  _ResepKategoriListState createState() => _ResepKategoriListState();
}

class _ResepKategoriListState extends State<ResepKategoriList> {
  int masakanCount = 0;
  List? masakan;
  ...
  Future initialize() async {
    masakan = [];
    masakan = await service.getResepCategory(widget.keyword);
    setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(children: [
        ...
        //       // super.initState();
        //       // setState(() => masakan?.add(new Masakan(
        //       //     'Resep Es Cincau Apel yang Menyegarkan dan Bikin Adem',
        //       //     'https://www.masakapahariini.com/wp-content/uploads/2021/02/Es-Cincau-Apel-400x240.jpg',
        //       //     "resep-es-cincau-apel",
        //       //     "20mnt",
        //       //     "4 Porsi",
        //       //     "Mudah")));
        //       // controller.clear();
